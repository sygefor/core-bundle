...
abstract class AbstractTraining implements SerializedAccessRights
{
    ...
    /**
     * @var ArrayCollection
     * @ORM\OneToMany(targetEntity="Sygefor\Bundle\CoreBundle\Entity\Session\AbstractSession", mappedBy="training", cascade={"persist", "remove"})
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Sygefor\Bundle\CoreBundle\Entity\Training\Term\AbstractTheme")
     * @ORM\JoinColumn(nullable=false)
     ...
     * @ORM\ManyToOne(targetEntity="Sygefor\Bundle\CoreBundle\Entity\Training\Term\TrainingCategory")
    ...
    /**
     * @var ArrayCollection
     * @ORM\ManyToMany(targetEntity="Sygefor\Bundle\CoreBundle\Entity\Training\Term\Tag")
    ...
    /**
     * @var ArrayCollection
     * @ORM\OneToMany(targetEntity="Sygefor\Bundle\CoreBundle\Entity\Material\Material", mappedBy="training", cascade={"remove", "persist"})
     * @ORM\JoinColumn(nullable=true)
    ...
    {
        return 'Sygefor\Bundle\CoreBundle\Form\TrainingType';
    }
