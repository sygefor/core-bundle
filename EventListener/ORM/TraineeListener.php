...
class TraineeListener implements EventSubscriber
{
    ...
    public function loadClassMetadata(LoadClassMetadataEventArgs $eventArgs)
    {
        ...
        if ($class === 'Sygefor\Bundle\CoreBundle\Entity\AbstractTrainee') {
    ...
    protected function sendCredentialsMail(AbstractTrainee $trainee, $new)
    {
        ...
        $body = $this->container->get('templating')->render('SygeforCoreBundle:Trainee:'.$template, $parameters);
    ...
    protected function sendActivationMail(AbstractTrainee $trainee, $new)
    {
        ...
        // generate body
        $body = $this->container->get('templating')->render('SygeforCoreBundle:Trainee:activation.txt.twig', $parameters);
